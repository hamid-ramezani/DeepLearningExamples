    ...
    if args.action == 'download':
        ...
        if args.dataset == 'bookscorpus':
            ...
            if args.skip_wikiextractor == 0:
                path_to_wikiextractor_in_container = '/nfs/scistore14/alistgrp/hramezan/DeepLearningExamples/PyTorch/LanguageModeling/wikiextractor/WikiExtractor.py'
        ...
        def create_record_worker(filename_prefix, shard_id, output_format='tfrecord'):
            bert_preprocessing_command = 'python /nfs/scistore14/alistgrp/hramezan/DeepLearningExamples/PyTorch/LanguageModeling/BERT/create_pretraining_data.py'
